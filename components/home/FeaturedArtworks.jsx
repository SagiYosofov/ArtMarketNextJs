...
// FeaturedArtworks component displays a curated selection of artworks on the home page
// Props:
// - artworksData: Object containing array of artwork information
// - isLoading: Boolean indicating if data is being fetched
// - error: String containing error message if fetch failed
// - onArtworkClick: Function to handle artwork selection
